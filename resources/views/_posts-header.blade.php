    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{show:false}" @click.away="show = false">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full mt-2 rounded-r-xl z-50" style="display:none">

                    <a href="/" class="block text-left leading-5 hover:bg-gray-300 focus:bg-gray-300">All</a>


                    <!--bind the display of this div to the truth value of the x-data div -->
                    @foreach ($toppings as $topping)
                        <a href="/toppings/{{$topping->slug}}" class="block text-left leading-5 hover:bg-gray-300 focus:bg-gray-300">{{ucwords($topping->name)}}</a>
                    @endforeach
                </div>
            </div>
        </div>
