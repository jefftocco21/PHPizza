<div>
    <x-custom-drop>
        ...
        <x-custom-drop-item href="/?{{ http_build_query(request()->except('topping', 'page'))}}"
            :active="request()->routeIs('home')">All
        </x-custom-drop-item>

        <!--bind the display of this div to the truth value of the x-data div -->
        @foreach ($toppings as $topping)
            <x-custom-drop-item href="/?topping={{ $topping->slug }}&{{ http_build_query(request()->except('topping', 'page'))}}"
